...
- anchor seeds must have direct receptor-residue contacts and are ranked first by local window `avg_contact_count`
- local `contact_coverage`, `longest_contact_run`, and direct anchor contact count are used as tie-breakers for anchor ranking
